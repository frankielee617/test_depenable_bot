<script>
  ...
  var mailtoLink = 'mailto:' + email + '?subject=' + encodeURIComponent("Interest in Mindtree Platform") + '&body=' + encodeURIComponent("");
  window.open(mailtoLink, '_blank');
  }
//fb
  /// https://www.facebook.com/profile.php?id=61561806922630
//instagram
/// https://www.instagram.com/mindtree_solutions/profilecard/?igsh=a216Z29ucDl3a3l2
</script>
<div class="container">
  <div class="subtitle colorsecondary" style="text-align:left">{m.contact_us()}</div>
</div>
  <div style="margin-bottom:0.5rem;"></div>
  <div style="display:flex; flex-wrap:wrap; width:100%; margin: 0 auto; column-gap:16px; row-gap:16px;padding: 0 15px;box-sizing:border-box; background:var(--backgroundYellow); padding:3rem 16px;">
<!--     <div class="box" on:click={()=>{ gotoPage("https://www.youtube.com/@mindtree-t6b")}}> -->
<!-- <svg xmlns="http://www.w3.org/2000/svg" width="5rem" height="5rem" viewBox="0 0 256 180" {...$$props}> -->
...
<!--   </div> -->
<!--     <div class="box" on:click={()=>{ gotoPage("https://www.facebook.com/profile.php?id=61561806922630")}}> -->
<!-- <svg xmlns="http://www.w3.org/2000/svg" width="5em" height="5em" viewBox="0 0 256 256" {...$$props}> -->
...
<!--   </div> -->
<!--     <div class="box" on:click={()=>{ gotoPage("https://www.instagram.com/mindtree_solutions/profilecard/?igsh=a216Z29ucDl3a3l2")}}> -->
<!--   <svg xmlns="http://www.w3.org/2000/svg" width="5rem" height="5rem" viewBox="0 0 256 256" {...$$props}> -->
<!-- 	<g fill="none"> -->
...
<!--   </div> -->
  <div class="box wm1000" on:click={()=>{ emailTo("business@mindtree.com.my")}}>
    <svg xmlns="http://www.w3.org/2000/svg" width="5rem" height="5rem" viewBox="0 0 24 24" {...$$props}>
      <path fill="#ff630f" d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2m0 4l-8 5l-8-5V6l8 5l8-5z" />
    </svg>
    <div class="smalltitle" style="margin-top:0; color:#000;">
      {m.email()}
    </div>
</div>
</div>
