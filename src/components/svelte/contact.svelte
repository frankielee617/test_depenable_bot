<script>
  ...
  function emailTo(email) {
    var mailtoLink =
      ...
      email +
      "?subject=" +
      encodeURIComponent("Interest in Mindtree Platform") +
      "&body=" +
      encodeURIComponent("");
...
<div class="container">
  <div class="subtitle colorsecondary" style="text-align:left">
    {m.contact_us()}
  </div>
</div>
<div style="margin-bottom:0.5rem;"></div>
<div
  style="display:flex; flex-wrap:wrap; width:100%; margin: 0 auto; column-gap:16px; row-gap:16px;padding: 0 15px;box-sizing:border-box; background:var(--backgroundYellow); padding:3rem 16px;"
>
  ...
  <div
    class="box wm1000"
    on:click={() => {
      emailTo("business@mindtree.com.my");
    }}
  >
    <svg
